...
export const MaterialLightTheme = {
  ...
  colors: {
    ...
    primaryContainer: '#8ba888',
    onPrimaryContainer: '#44624a',
    secondary: '#8ba882',
...
export const MaterialDarkTheme = {
  ...
  colors: {
    primary: '#8ba888',
    onPrimary: '#44624a', //a
    primaryContainer: '#75957B',
    onPrimaryContainer: '#D6FADC',
    secondary: '#9FAFA1',
    onSecondary: '#575878',
    secondaryContainer: '#8A8AAC',
    ...
    backdrop: 'rgba(44, 49, 55, 0.4)',
    customHeader: '#3C4A3E', //'rgb(38, 20, 49)'
  },
};
